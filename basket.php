            ...
            <div class="navbar-header">
                ...
                <div class="navbar-buttons">
                    ...
                    <a class="btn btn-default navbar-toggle" href="basket.php">
                        <i class="fa fa-shopping-cart"></i>  <span class="hidden-xs"><?php echo $_SESSION['Count']; ?> items in cart</span>
                    </a>
                </div>
            </div>
            <!--/.navbar-header -->
            ...
            <div class="container">
                ...
                <div class="col-md-9" id="basket">
                    ...
                    <div class="box">
                        ...
                        <form id="cart" method="post" action="basket.php?action=update">

                            <h1>Shopping cart</h1>
                            <p class="text-muted">You currently have <?php echo $_SESSION['Count']; ?> item(s) in your cart.</p>
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    ...
                                    <button type="button" onclick="checkCart()" class="btn btn-primary">Proceed to checkout <i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <th><?php echo "$".sprintf("%.2f",$_SESSION['subtotal']); ?></th>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>GST 10%</td>
                                        <th><?php echo "$".sprintf("%.2f",$_SESSION['subtotal']*0.1); ?></th>
                                    </tr>
                                    <tr class="total">
                                        <td>Total</td>
                                        <th><?php echo "$".sprintf("%.2f",($_SESSION['subtotal']+ 20 + $_SESSION['subtotal']*0.1)); ?></th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
