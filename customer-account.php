<?php
	...
	require_once('php/global-connect.inc.php');
	// Include functions
 ...
 _________________________________________________________ -->
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li>
                                    <a href="php/functions.inc.php?action=logout"><i class="fa fa-sign-out"></i> Logout</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-md-9">
                    <div class="box">
                        ...
                        <form id = "changePasswordForm" method = "get" action="">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                            ...
                            <div class="col-sm-12 text-center">
                                <button type="button" id="changePasswordSubmit" onclick="ChangePassword()" class="btn btn-primary"><i class="fa fa-save"></i> Save new password</button>
                            </div>
                        </form>
                        ...
                        <form id = "PersonalDetailForm" method = "get" action="">
                            <div class="row">
                                <div class="col-sm-6">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id = "address" name="address" placeholder = "please input characters and/or numbers" onblur="ValidateInput(this.id, this.value)">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id = "company" name="company" placeholder = "please input characters " onblur="ValidateInput(this.id, this.value)">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id = "city" name="city" placeholder = "please input characters" onblur="ValidateInput(this.id, this.value)" >
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id = "postcode" name="postcode" placeholder = "please input Australia postcode" onblur="ValidateInput(this.id, this.value)">
                               ...
                               <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="telephone" name="telephone" placeholder = "please input Australia phone number" onblur="ValidateInput(this.id, this.value)">
							...
							<div class="row">	
                                <div class="col-sm-12 text-center">
                                    <button type="button" id = "submit" onclick = "ChangeDetail()" class="btn btn-primary"><i class="fa fa-save"></i> Save changes</button>
                                </div>
							</div>
                        </form>
                    </div>
