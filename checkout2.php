...
<body>
        ...
        <div class="container">
                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-6"> <!-- col-sm-3 is changed to col-sm-6 by Shang-->
                                            <h5>Furniture</h5>
                                            <ul>
                                                <li><a href="shop-furniture.html?value=Chairs">Chairs</a>
                                                </li>
                                                <li><a href="shop-furniture.html?value=Beds">Beds</a>
                                                </li>												
                                                <li><a href="shop-furniture.html?value=Tables">Tables</a>
                                                </li>
												<li><a href="shop-furniture.html?value=Storage">Storage</a>
                                                </li>
                                        ...
                                        <div class="col-sm-6"> <!-- col-sm-3 is changed to col-sm-6 by Shang-->
                                            <h5>Accessories</h5>
                                            <ul>
                                                <li><a href="shop-furniture.html?value=HomeDeco">Home Deco</a>
                                                </li>
                                                <li><a href="shop-furniture.html?value=TextilesRugs">Textiles & Rugs</a>
                                                </li>
												<li><a href="shop-furniture.html?value=Lighting">Lighting</a>
                                                </li>
												<li><a href="shop-furniture.html?value=PlantpotsStands">Plant pots & Stands</a>
                                                </li>												
                                            </ul>
                                        </div>                                        
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="shop-furniture.html?value=furniture">Shop - furniture</a>
                                                </li>
												<li><a href="shop-furniture.html?value=accessories">Shop - accessories</a>
                                                </li> 
                                            </ul>
                                        </div>
                                        <div class="col-sm-3">
            ...
            <div class="navbar-buttons">
                ...
                <div class="navbar-collapse collapse right" id="basket-overview">
                    <a href="basket.html" class="btn btn-primary navbar-btn"><i id = "itemAmount" class="fa fa-shopping-cart"></i><span class="hidden-sm"></span></a>
                </div>
                <!--/.nav-collapse -->
        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form id = "checkout2Form" method="get" action="" >
                                        ...
                                        <div class="box payment-method">
											...
											<div class="row">
											  <div class="col-sm-10 form-group">
												<input type="text" id = "cardname" name="cardname" placeholder="Name On Card"  class="form-control" onblur="ValidateInput(this.id, this.value)">
                                                <span id = "cardnameError" style="color:red"></span>
                                              </div>
											  <div class="col-sm-10 form-group">
												<input type="text" id = "cardnumber" name="cardnumber" placeholder="Card Number (16 digits)" maxlength="16"  class="form-control" onblur="ValidateInput(this.id, this.value)">
                                                <span id = "cardnumberError" style="color:red"></span>
                                              </div>
											  <div class="col-sm-4 form-group">
												<input type="text" id = "expirymonth" name="expirymonth" placeholder="Expiry Month: XX" maxlength="2" class="form-control" onblur="ValidateInput(this.id, this.value)">
                                                <span id = "expirymonthError" style="color:red"></span>
                                              </div>
											  <div class="col-sm-4 form-group">
												<input type="text" id = "expiryyear" name="expiryyear" placeholder="Expiry Year: XXXX" maxlength="4" class="form-control"  onblur="ValidateInput(this.id, this.value)">
                                                <span id = "expiryyearError" style="color:red"></span>
                                              </div>
											  <div class="col-sm-4 form-group">
												<input type="text" id = "cvv" name="cvv" placeholder="CVV: XXX" maxlength="3"  class="form-control" onblur="ValidateInput(this.id, this.value)">
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <button type="button" id="submit" onclick = "UploadCheckout2()" class="btn btn-primary">Continue to Order review<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <th><?php  echo "$".sprintf("%.2f",$subtotal); ?></th>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>GST 10%</td>
                                        <th><?php  echo "$".sprintf("%.2f",$subtotal*0.1); ?></th>
                                    </tr>
                                    <tr class="total">
                                        <td>Total</td>
                                        <th><?php echo "$".sprintf("%.2f",($subtotal+ 20 + $subtotal*0.1)); ?></th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
 ...
 _________________________________________________________ -->
    ...
    <!-- scripts added by Wentao Yan at 31/08/2018 -->
