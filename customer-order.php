...
// Find Order detail info
$detailID = "SELECT * FROM OrderDetail WHERE DetailID = $id";
$stmt = oci_parse($db, $detailID);
if(!$stmt)  {
...
while(oci_fetch_array($stmt)){
	...
	$cart=oci_result($stmt,"CARTDATA");
	$userID=oci_result($stmt,"USER_ID");
	$date=oci_result($stmt,"PURCHASEDATE");
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9" id="customer-order">
                    <div class="box">
                        ...
                        <p class="lead">Order #<?echo $id;?> was placed on <strong><?echo $date;?></strong> and is <strong>delivered</strong>.</p>
                            ...
                            <table class="table">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>$<?php echo sprintf("%.2f",$total); ?></th>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <th>$<?php echo sprintf("%.2f",$total*0.1); ?></th>
                                    </tr>
                                    <tr>
                                        <th colspan="5" class="text-right">Total</th>
                                        <th>$<?php echo sprintf("%.2f",($total+20+$total*0.1)); ?></th>
                                    </tr>
                                </tfoot>
                            </table>
