        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form id = "checkout1Form" method = "get" action="" >
                            <h1>Checkout</h1>
                            ...
                            <div class="content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id = "postcode" name="postcode" placeholder = "please input AU postcode" onblur="ValidateInput(this.id, this.value)">
                                ...
                                <!-- added another row for telephone and email address -->
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <button type="button" id="submit" onclick = "UploadCheckout1()" class="btn btn-primary">Continue to Payment Method<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
